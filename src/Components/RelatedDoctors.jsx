  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10">
      ...
      <div className="text-center mt-8">
        <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className="px-6 py-3 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition duration-300">
          More
        </button>
      </div>
    </div>
